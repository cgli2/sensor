...
public final class CRC16 {
	 ...
	 * @return Hex形式的数据。
	 */
	public static String getCrcHex(byte[] data){
		return Integer.toHexString(calcCrc16(data));
	}
	...
	public static byte[] getCrcBytes(byte[] data){
		int value = calcCrc16(data);
		String hex = Integer.toHexString(value);
		return DataFormater.hexStringToBytes(hex);
	}

	public static void main(String[] args) {
		// 0x02 05 00 03 FF 00 , crc16=7C 09
//		byte[] data = new byte[] { (byte) 0x25, (byte) 0x41, (byte) 0x61, (byte) 0x01, (byte) 0x03,
//				(byte) 0x22, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x2F, (byte) 0x00, (byte) 0x24, (byte) 0x19,
//				(byte) 0x47, (byte) 0x35, (byte) 0x32, (byte) 0x35, (byte) 0x38, (byte) 0x33, (byte) 0x39, (byte) 0x00,
//				(byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x40, (byte) 0x00,
//				(byte) 0x00, (byte) 0x00, (byte) 0x44, (byte) 0x48, (byte) 0x4C, (byte) 0xCD, (byte) 0x55 };
//		int crc = CRC16.calcCrc16(data,0,data.length,0xffff);
//		System.out.println(crc);
//		System.out.println(Integer.toHexString(crc));
//		byte[] ret = getCrcBytes(data);
	}
}
